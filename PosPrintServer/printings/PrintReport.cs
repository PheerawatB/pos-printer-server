...
public class PrintReport
{
    ...
    static void AddShop(IntPtr printer, Report reportBill)
    {
        ...
        if (reportBill.shop != null)
        {
            ...
            //{
            //    branchName = $"{(!string.IsNullOrEmpty(reportBill.shop.branch) ? (language == "th" ? "�Ңҷ�� " : "Branch No. ") + reportBill.shop.branch : "")}" +
            //                 $"{(reportBill.shop.branch != null && !string.IsNullOrEmpty(reportBill.shop.branch) ? " " : "")}" +
            //                 $"{(!string.IsNullOrEmpty(reportBill.shop.branch) ? (language == "th" ? "�Ң� " : "Branch ") + reportBill.shop.branch : "")} ";
            //}
            ...
            string shopName = $"{(reportBill.language == "th" ? "������ҹ�����" : "Shop Name")}: {reportBill.shop.name ?? ""}";
            PM.PrintText(printer, shopName);

            string branch = $"{(reportBill.language == "th" ? "�Ң�" : "Branch")}: {reportBill.shop.branch ?? ""}";
            PM.PrintText(printer, branch);

            string addr = $"{(reportBill.language == "th" ? "�������" : "Address")}: {reportBill.shop.address ?? ""}";
        ...
        //{
        //    string taxNo = $"{(language == "th" ? "�Ţ��Шӵ�Ǽ����������" : "TAX ID")} {bill.shop.tax_no} ";
        //    PM.PrintText(printer, FormatText(taxNo));
        //}
        PM.NewLine(printer, 50);
        //string tel = $"{(language == "th" ? "������" : "Tel")} {bill.shop.tel ?? ""} ";
    ...
    static void AddHeader(IntPtr printer, Report reportBill)
    {
        ...
        if (reportBill.pos_round != null)
        {
            ...
            string posInfo = $"{(reportBill.language == "th" ? "��������ͧ" : "POS Code")} : {reportBill.pos_round.pos_code} " +
                             $"{(reportBill.language == "th" ? "�ͺ���" : "Work shift")} : {reportBill.pos_round.round}";
            PM.PrintText(printer, posInfo);

            // Title
            string title = reportBill.language == "th" ? "���ػ�ʹ�����鹪ѡ�Թʴ" : "Cash register report";
            PM.PrintText(printer, title);

            // Starting Date and Time
            string startingDate = $"{(reportBill.language == "th" ? "�ѹ����Դ��鹪ѡ�Թʴ" : "Starting date")} : " +
                                  $"{DateTime.Parse(reportBill.pos_round.open_date).ToString("dd MMMM yyyy", new System.Globalization.CultureInfo(language))} " +
                                  $"{(reportBill.language == "th" ? "����" : "time")} {reportBill.pos_round.open_time}";
            PM.PrintText(printer, startingDate);

            // Ending Date and Time
            string endingDate = $"{(reportBill.language == "th" ? "�ѹ���Դ��鹪ѡ�Թʴ" : "Ending date")} : " +
                                $"{DateTime.Parse(reportBill.pos_round.close_date).ToString("dd MMMM yyyy", new System.Globalization.CultureInfo(language))} " +
                                $"{(reportBill.language == "th" ? "����" : "time")} {reportBill.pos_round.close_time}";
        ...
        else
        {
            ...
            //if (reportBill.summary_date != null)
            {
                ...
                string docDate = $"{(reportBill.language == "th" ? "���ػ�ʹ�����͹" : "Summary report of monthly sales")} : {GetMonthName(reportBill.date, language)}";
            ...
            else
            {
                ...
                string docDate = $"{(reportBill.language == "th" ? "���ػ�ʹ����ѹ���" : "Summary report of daily sales")} : " +
        ...
        //{
        //    string report_name = $"{(reportBill.language == "th" ? "��ػ�ʹ������ѹ���" : "Report Summary Date")} {summaryDate.ToString("dd MMMM yyyy", new System.Globalization.CultureInfo(reportBill.language == "th" ? "th-TH" : "en-US"))}";
        //    PM.PrintText(printer, report_name);
        //}
        //else
        //{
        //    // �óշ���������ö�ŧ string �� DateTime ��
        //    string report_name = "Invalid date format";
        //}
        // Print Date
        lineIndex += 2;
        string printDate = $"{(reportBill.language == "th" ? "�����������ѹ���" : "Print date")} : " +
            $"{DateTime.Now.ToString("dd MMMM yyyy HH:mm", new System.Globalization.CultureInfo(language))}" +
            $"{(reportBill.language == "th" ? " �." : "")}";
        ...
        // Number of Bills
        lineIndex += 4;
        string title_bill_count_total = reportBill.language == "th" ? "�ӹǹ��ŷ�����" : "Number of bills";
        ...
        lineIndex += 2;
        string title_cancelledBills = reportBill.language == "th" ? "�ӹǹ���¡��ԡ" : "Number of cancelled receipt";
        ...
        lineIndex += 2;
        string title_cancelledNotBills = reportBill.language == "th" ? "�ӹǹ��ŷ��Դ��С�͹����" : "Number of cancelled bill";
        ...
        lineIndex += 2;
        string title_bill_item_count_cancel = reportBill.language == "th" ? "�ӹǹ��¡�÷��¡��ԡ" : "Number cancelled item";
        ...
        // Number of Customers
        lineIndex += 2;
        string title_bill_count_customer = reportBill.language == "th" ? "�ӹǹ�١���" : "Number of customers";
        ...
        string title_normalBills = reportBill.language == "th" ? "�ҡ�ӹǹ���" : "from Bills";
    ...
    {
        string discountTitle = reportBill.language == "th" ? "��ǹŴ" : "Sales discount";
        string specialTitle = reportBill.language == "th" ? "��ǹŴ�����" : "Additional sales discount";
        string freeTitle = reportBill.language == "th" ? "���" : "Discount of free items";
        string decimalDiscountTitle = reportBill.language == "th" ? "��ǹŴ�Ѵ���ʵҧ��" : "Discount of Round down to decimal";
        string totalDiscountTitle = reportBill.language == "th" ? "�����ǹŴ" : "Total sales discount";
        string serviceTitle = reportBill.language == "th" ? "��Һ�ԡ��" : "Service Charge";
    ...
    {
        string noVatTitle = reportBill.language == "th" ? "�ʹ���������������Ť������" : "Pre-vat Amount";
        string vatTitle = reportBill.language == "th" ? "���բ��" : "VAT";
        string grandTotalTitle = reportBill.language == "th" ? "�ʹ����ط��" : "Grand Total";
    ...
    {
        string paymentMethodTitle = reportBill.language == "th" ? "��ͧ�ҧ��ê����Թ" : "Payment methods";
        string cashTitle = reportBill.language == "th" ? "�Թʴ" : "Cash";
        string depositTitle = reportBill.language == "th" ? "�Թ�Ѵ��" : "Deposit";
        ...
        foreach (var qr_payment in reportBill.receipt_payment_qr_code)
        {
            ...
            string payCount = $"{payCountNum} {(reportBill.language == "th" ? "����" : "times")}";
            string transferTitle = $"{(reportBill.language == "th" ? "�Թ�͹ / QR Code" : "Bank transfer")} {qr_payment.bank_short_name} {payCount}";
            ...
            if (qr_payment.bank_account_payment_methods.Any(m => m.bank_account_payment_method_name != null))
            {
                foreach (var method in qr_payment.bank_account_payment_methods)
                {
                    string methodTitle = $"{method.bank_account_payment_method_name ?? (reportBill.language == "th" ? "����к�" : "Not specified")} ({method.payment_count} {(reportBill.language == "th" ? "����" : "times")})";
        ...
        {
            string payCount = $"{credit_card.payment_count} {(reportBill.language == "th" ? "����" : "times")}";
            string creditTitle = $"{(reportBill.language == "th" ? "�ѵ��ôԵ" : "Credit/Debit card Bank")} {credit_card.bank_short_name} {payCount}";
            PM.PrintTextTwoColumn(printer, creditTitle, CurrencyFormat($"{credit_card.amount}"));
        }

        string invoiceTitle = reportBill.language == "th" ? "�Թ����" : "On credit";
        PM.PrintTextTwoColumn(printer, invoiceTitle, CurrencyFormat($"{reportBill.invoice_total_after_vat}"));
        PM.DrawLine(printer);

        string tipsTitle = reportBill.language == "th" ? "�Ի" : "Tips";
        PM.PrintTextTwoColumn(printer, tipsTitle, CurrencyFormat($"{reportBill.pos_round_close_tip_amount}"));
        PM.DrawLine(printer);

        string netTitle = reportBill.language == "th" ? "�ʹ����ط������Ի" : "Net Total";
    ...
    {
        string billingTitle = reportBill.language == "th" ? "����� ������������" : "Sales report by bill type";
        string atShopTitle = reportBill.language == "th" ? "�ҹ��ҹ" : "Eat in";
        string takeHomeTitle = reportBill.language == "th" ? "��Ѻ��ҹ" : "Take home";
        ...
        if (reportBill.pos_round != null) 
        {
            string initialTitle = reportBill.language == "th" ? "ǧ�Թʴ�������" : "Begining balance of cash";
            PM.PrintTextTwoColumn(printer, initialTitle, CurrencyFormat($"{reportBill.pos_round.initial_amount}"));
            string incomeTitle = reportBill.language == "th" ? "�Թ���" : "Cash In";
            string outcomeTitle = reportBill.language == "th" ? "�Թ�͡" : "Cash Out";
            string registerCashTitle = reportBill.language == "th" ? "�ӹǹ�Թ����к�" : "Amount of cash receipt by register";
            string onHandCashTitle = reportBill.language == "th" ? "�ӹǹ�Թ���Ѻ��ҡ��鹪ѡ" : "Amount of cash on hand";
            string overShortTitle = reportBill.language == "th" ? "�Թ�Թ / -�Թ�Ҵ" : "Over/Short of cash";
            string depositCashTitle = reportBill.language == "th" ? "�ӹǹ�Թ �ӽҡ�Թ��Ҹ�Ҥ��" : "Amount of money deposited into the bank";
        ...
        {
            string estimatedTitle = reportBill.language == "th" ? "��������ҳ��èҡ��ŷ���ѧ�������Թ" : "Estimated sales of unpaid bills";
            string unpaidTitle = reportBill.language == "th" ? "��ŷ���ѧ�������Թ" : "Number of unpaid bills";
    ...
    static void AddProducts(IntPtr printer, Report reportBill)
    {
        ...
        if (reportBill.product_types != null) // Correctly access product_types from reportBill
        {
            ...
            foreach (var type in reportBill.product_types)
            {
                ...
                if (!types.ContainsKey(type.product_type_name))
                {
                    ...
                    {
                        string totalKey = (reportBill.language == "th" ? "���" : "Total") + prevType;
        ...
        PM.NewLine(printer);
        PM.PrintTextTwoColumn(printer, reportBill.language == "th" ? "�ʹ������" : "Total Amount", CurrencyFormat(totalPrice.ToString()));
        PM.NewLine(printer);
    }
    ...
    public static Report GenerateMockBillData()
    {
        ...
        string json = @"
        {
          ""shop"": {
            ...
            ""address"": ""��Ԫѵ ầ�͡ ���� ��������� �ӡѴ �ӹѡ�ҹ�˭� �Ţ��� 832 ����ط����� �Ѫ�����ɡ ࢵ �Թᴧ ��ا෾��ҹ�� 10400"",
            ""service_charge"": 10,
        ...
        //    ""name"": ""ʵ�շ�Ϳ���"",
        //    ""branch_name"": ""STREET COFFEE 3"",
        //    ""address"": ""����ǳ ầ�͡ ���� ��������� �ӡѴ �ӹѡ�ҹ�˭� �Ţ��� 832 ����ط����� �Ѫ�����ɡ ࢵ �Թᴧ ��ا෾��ҹ�� 10400"",
        //    ""service_charge"": 10,
        //    ""is_show_report_by_menu"": false,
        //    ""default_report_printer_id"": 5,
        //    ""image_url"": """"
        ...
        //    ""name"": ""ʵ�շ�Ϳ���"",
        //    ""branch_name"": ""STREET COFFEE 3"",
        //    ""address"": ""����ѵ�� ầ�͡ ���� ��������� �ӡѴ �ӹѡ�ҹ�˭� �Ţ��� 832 ����ط����� �Ѫ�����ɡ ࢵ �Թᴧ ��ا෾��ҹ�� 10400"",
        //    ""service_charge"": 10,
        //    ""is_show_report_by_menu"": false,
        //    ""default_report_printer_id"": 5,
        //    ""image_url"": """"
